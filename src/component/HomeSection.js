        ...
        <aside className="home-content-section">
          <div className="home-container">
            <h1 className="h-of-home-container">
              Make Your Ride <br /><span id="span-of-h">Easy & Affordable</span>
            </h1>
            <p>
            ...
            <div className="home-btn">
              <button className="home-container-btn" id="left-home-container-btn">
                Book Now
              </button>
              <button className="home-container-btn" id="right-home-container-btn">
